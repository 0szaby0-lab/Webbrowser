...
# Automatikus átirányítás a teljes képernyős VNC-re
...
# Supervisord konfiguráció (Itt cseréltük le a Discordot Yahoo-ra)
...
\n\
[program:chromium]\n\
command=/bin/bash -c "sleep 4 && /usr/bin/chromium --no-sandbox --disable-dev-shm-usage --disable-gpu --window-size=1280,720 --window-position=0,0 --kiosk https://yahoo.com"\n\
priority=60\n\
